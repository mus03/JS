...
// the model, brand, and price. Your task is to write a JavaScript function named findAveragePhonePrice
...
console.log(AveragePriceOfPhone.toFixed(2)); //returns string
